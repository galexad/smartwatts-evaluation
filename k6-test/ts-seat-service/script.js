...
const BASE_URL = "http://145.108.225.17:18898";
...
export default function(authToken) {
    ...
    group("/api/v1/seatservice/seats", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/seatservice/seats`;
    ...
    group("/api/v1/seatservice/welcome", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/seatservice/welcome`;
    ...
    group("/api/v1/seatservice/seats/left_tickets", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/seatservice/seats/left_tickets`;
            let body = {"destStation": "", "seatType": 2, "startStation": "", "trainNumber": "G1235", "travelDate": "28-06-2022"};
            let request = http.post(url, JSON.stringify(body), params);
