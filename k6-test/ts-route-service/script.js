...
const BASE_URL = "http://145.108.225.17:11178";
...
export default function(authToken) {
    ...
    group("/api/v1/routeservice/routes", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/routeservice/routes`;
    ...
    group("/api/v1/routeservice/routes/{startId}/{terminalId}", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/routeservice/routes/${startId}/${terminalId}`;
            let request = http.get(url, params);
    ...
    group("/api/v1/routeservice/welcome", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/routeservice/welcome`;
            let request = http.get(url, params);
    ...
    group("/api/v1/routeservice/routes/{routeId}", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/routeservice/routes/${routeId}`;
            let request = http.get(url, params);
