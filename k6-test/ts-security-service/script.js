...
const BASE_URL = "http://145.108.225.17:11188";
...
export default function(authToken) {
    ...
    group("/api/v1/securityservice/securityConfigs", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/securityservice/securityConfigs`;
    ...
    group("/api/v1/securityservice/welcome", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/securityservice/welcome`;
            let request = http.get(url, params);
    ...
    group("/api/v1/securityservice/securityConfigs/{accountId}", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/securityservice/securityConfigs/${accountId}`;
            let request = http.get(url, params);
    ...
    group("/api/v1/securityservice/securityConfigs/{id}", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/securityservice/securityConfigs/${id}`;
