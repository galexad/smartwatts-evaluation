...
const BASE_URL = "http://145.108.225.17:14569";
...
export default function(authToken) {
    ...
    group("/api/v1/preserveotherservice/welcome", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/preserveotherservice/welcome`;
    ...
    group("/api/v1/preserveotherservice/preserveOther", () => {
        ...
        // Request No. 1
        {
            let url = BASE_URL + `/api/v1/preserveotherservice/preserveOther`;
            let body ={
